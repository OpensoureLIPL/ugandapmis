...
<table class="table table-bordered data-table">
    <thead>
        <tr>
            <th>SL#</th>
            <th>Magisterial Area Name</th>
            <th>Magisterial Area Id</th>
            <th>Desciption</th>
<?php
if(!isset($is_excel)){
?> 
...
?>
        <tr>
            ...
            <td><?php echo $data['Magisterial']['name']; ?></td>
             <td><?php echo $data['Magisterial']['magisterial_area_id']; ?></td>
             <td><?php echo $data['Magisterial']['description']; ?></td>
<?php
        if(!isset($is_excel)){
?>              
            <td>
