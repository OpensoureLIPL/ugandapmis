...
?>        
        <li class="submenu <?php echo $multimenu;?>"> 
            <a href="#"><i class="icon icon-th-list"></i> <span><?php echo $menuKey?></span></a>
            <ul>
<?php
...
?>            
                <li class=" <?php if(is_string($subMenuVal) && ($menuUrl == $subMenuVal)){echo 'active';}?>">
                    <?php echo $this->Html->link('<i class="icon icon-th-list"></i>'.$submenuKey,$subMenuVal,array('escape'=>false));?>
                </li>
<?php
            }
?>                
...
?>
        <li class=" <?php if(is_string($menuVal) && ($menuUrl == $menuVal)){echo 'active';}?>">
            <?php echo $this->Html->link('<i class="icon icon-th-list"></i>'.$menuKey,$menuVal,array('escape'=>false));?>
        </li>
<?php            
        }
    }
