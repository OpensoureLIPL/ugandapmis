...
<table id="districtTable" class="table table-bordered table-striped">
  <thead>
    <tr>
      ...
      <th><?php echo $this->Paginator->sort('Classification Name'); ?></th>
...
?>
    <tr>
      ...
      <td><?php echo ucwords(h($data['Classification']['name'])); ?>&nbsp;</td> 
      
      
         				
      
        <td class="actions">
          <?php echo $this->Form->create('ClassificationEdit',array('url'=>'/classifications/','admin'=>false));?> 
          <?php echo $this->Form->input('id',array('type'=>'hidden','value'=> $data['Classification']['id'])); ?>
