            ...
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                    ...
                    <div style="float:right;padding-top: 7px;">
                        <?php echo $this->Html->link(__('Add New Section Of Law'), array('action' => 'add'), array('escape'=>false,'class'=>'btn btn-primary')); ?>
                        &nbsp;&nbsp;
                    </div>
                </div>
                    ...
                    <div class="row" style="padding-bottom: 14px;">
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo $this->Form->input('offence_id', array('type'=>'select','class'=>'form-control','id'=>'offence_id','options'=>$offenceList,'empty'=>'--All--','div'=>false,'label'=>false,'onchange'=>''))?>
                                </div>
                            </div>
                        </div>
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo $this->Form->input('solname', array('type'=>'text','class'=>'form-control','id'=>'solname','div'=>false,'label'=>false))?>
                                </div>
                            </div>
                        </div>  
