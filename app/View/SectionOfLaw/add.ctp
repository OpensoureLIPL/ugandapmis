            ...
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    ...
                    <div style="float:right;padding-top: 7px;">
                        <?php echo $this->Html->link(__('SectionOfLaws'), array('action' => 'index'), array('escape'=>false,'class'=>'btn btn-primary')); ?>
                        &nbsp;&nbsp;
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo $this->Form->input('offence_id',array('type'=>'select', 'div'=>false,'label'=>false,'class'=>'form-control','required','options'=>$offenceList, 'empty'=>'--Select Region--'));?>
                                </div>
                            </div>
                        </div>                    
                        <div class="span4">
