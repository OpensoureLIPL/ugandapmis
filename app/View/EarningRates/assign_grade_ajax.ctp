...
?>
    <tr>
      ...
      <td><?php echo ucwords(h($data['EarningRate']['EarningGrade']['name'])); ?>&nbsp;</td>
      
      <td><?php echo ucwords(h($data['EarningRatePrisoner']['date_of_assignment'])); ?>&nbsp;</td>
      
      <td><?php echo ucwords(h($data['EarningRatePrisoner']['remarks'])); ?>&nbsp;</td>
     
         				
      
        <td class="actions">
          <?php echo $this->Form->create('EarningRatePrisonerEdit',array('url'=>'/earningRates/assignGrades','admin'=>false));?> 
          <?php echo $this->Form->input('id',array('type'=>'hidden','value'=> $data['EarningRatePrisoner']['id'])); ?>
        ...
        <td>
            <?php echo $this->Form->create('EarningRatePrisonerDelete',array('url'=>'/earningRates/assignGrades','admin'=>false));?> 
            <?php echo $this->Form->input('id',array('type'=>'hidden','value'=> $data['EarningRatePrisoner']['id'])); ?>
