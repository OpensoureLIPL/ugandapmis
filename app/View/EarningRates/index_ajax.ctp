...
?>
    <tr>
      ...
      <td><?php echo ucwords(h($data['EarningRate']['amount'])); ?>&nbsp;</td>
      <td><?php echo ucwords(h($data['EarningRate']['start_date'])); ?>&nbsp;</td> 
      <td><?php echo ucwords(h($data['EarningRate']['end_date'])); ?>&nbsp;</td>
      
      <td><?php echo ucwords(h($data['EarningRate']['comment'])); ?>&nbsp;</td>
     
         				
      
        <td class="actions">
          <?php echo $this->Form->create('EarningRateEdit',array('url'=>'/earningRates/index','admin'=>false));?> 
