                    ...
                    <div class="row" style="padding-bottom: 14px;">
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo $this->Form->input('usertype_id',array('div'=>false,'label'=>false,'class'=>'form-control validate','id'=>'usertype_id','options'=>$usertypeList,'empty'=>'--Select--','onchange'=>'javascript:getMenu();'));?>
                                </div>
                            </div>
                        </div> 
                    </div>
