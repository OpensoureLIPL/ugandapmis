            ...
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    ...
                    <div style="float:right;padding-top: 7px;">
                        <?php echo $this->Html->link(__('Offence List'), array('action' => 'index'), array('escape'=>false,'class'=>'btn btn-primary')); ?>
                        &nbsp;&nbsp;
                    </div>
                </div>
                <div class="widget-content nopadding">
                    <?php echo $this->Form->create('Offence',array('class'=>'form-horizontal'));?>
                    ...
                    <div class="row">     
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo $this->Form->input('name',array('div'=>false,'label'=>false,'placeholder'=>'Enter Offence','class'=>'form-control','required'));?>
                                </div>
                            </div>
                        </div>
                        <div class="span6">
