                                    ...
                                    <div class="span6">
                                     ...
                                     <div class="span6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <?php echo $this->Form->input('prisoner_name',array('div'=>false,'label'=>false,'class'=>'form-control span11','class'=>'form-control datepicker','type'=>'text','placeholder'=>'Enter Station Number ','id'=>'prisoner_name','readonly'));?>
                                            </div>
                                        </div>
                                    </div>
                                   </div>
                                <div class="row-fluid" style="padding-bottom: 14px;">
                                    ...
                                    <div class="span6">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <?php echo $this->Form->input('date_of_pay',array('div'=>false,'label'=>false,'class'=>'form-control span11','class'=>'form-control mydate ','type'=>'text','readonly','placeholder'=>'Enter date of pay','id'=>'date_of_pay'));?>
                                            </div>
                                        </div>
                                    </div>
                                     <div class="span6">
                                    ...
                                    <div class="span6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <?php echo $this->Form->input('balance',array('div'=>false,'label'=>false,'class'=>'form-control span11','class'=>'form-control','type'=>'text','placeholder'=>'Enter Balance ','id'=>'balance','readonly'));?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="span6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <?php echo $this->Form->input('checked_by_oc',array('div'=>false,'label'=>false,'type'=>'text','placeholder'=>'EnterChecked By O/C','class'=>'form-control','required'));?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="span6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <?php echo $this->Form->input('confirmed_prisoner',array('div'=>false,'label'=>false,'class'=>'form-control span11','class'=>'form-control','type'=>'text','placeholder'=>'Enter Confirmed Prisoner ','id'=>'confirmed_prisoner'));?>
                                            </div>
                                        </div>
                                    </div>
