...
?>
        <tr>
            ...
            <td><?php echo $data['WorkingParty']['officer_incharge']; ?></td>
<?php
        if(!isset($is_excel)){
?>              
            
            <td>
                <?php echo $this->Form->create('workingPartyEdit',array('url'=>'/earnings/workingParties','admin'=>false));?> 
              ...
              <td>
                   <?php echo $this->Form->button('Delete', array('type'=>'button', 'div'=>false, 'label'=>false, 'class'=>'btn btn-danger', 'onclick'=>"javascript:deleteworkingParty('$id');"))?>
            </td>
  <?php
}
  ?>
