            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <div class="">
                                ...
                                <div class="row-fluid" style="padding-bottom: 14px;">
                                    <div class="span6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <?php echo $this->Form->input('attendance_date',array('div'=>false,'label'=>false,'class'=>'form-control mydate','type'=>'text', 'placeholder'=>'Enter Date of Attendance','required','readonly'=>'readonly','id'=>'attendance_date'));?>
                        ...
                        <?php echo $this->Form->button('Continue', array('type'=>'button', 'div'=>false,'label'=>false, 'class'=>'btn btn-success', 'formnovalidate'=>true, 'onclick'=>'javascript:showPrisoners();'))?>
                    </div>
