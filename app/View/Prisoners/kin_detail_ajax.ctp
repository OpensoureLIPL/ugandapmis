...
?>
        <tr>
            ...
            <td><?php echo $data['PrisonerKinDetail']['last_name']; ?></td>
            <td><?php echo $data['PrisonerKinDetail']['relationship']; ?></td>
            <td><?php echo $data['PrisonerKinDetail']['phone_no']; ?></td>
            <td><?php echo $data['PrisonerKinDetail']['village']; ?></td>
<?php
        if(!isset($is_excel)){
?>              
            
            <td>
                <?php echo $this->Form->create('PrisonerDataEdit',array('url'=>'/Prisoners/edit/'.$puuid.'#kin_details','admin'=>false));?> 
              ...
              <td>
                   <?php echo $this->Form->button('Delete', array('type'=>'button', 'div'=>false, 'label'=>false, 'class'=>'btn btn-danger', 'onclick'=>"javascript:deleteKin('$id');"))?>
            </td>
  <?php
}
  ?>
