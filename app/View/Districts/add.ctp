            ...
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                    ...
                    <div style="float:right;padding-top: 7px;">
                        <?php echo $this->Html->link(__('District List'), array('action' => 'index'), array('escape'=>false,'class'=>'btn btn-primary')); ?>
                        &nbsp;&nbsp;
                    </div>
                </div>
                <div class="widget-content nopadding">
                    ...
                    <div class="row">
                        ...
                        <div class="span4">
                            <div class="control-group">
                                <label class="control-label">District<?php echo MANDATORY; ?> :</label>
                                <div class="controls">
                                    <?php echo $this->Form->input('name',array('div'=>false,'label'=>false,'placeholder'=>'Enter District','class'=>'form-control','required'));?>
                                </div>
                            </div>
                        </div>
                        <div class="span4">
