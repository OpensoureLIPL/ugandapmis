        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                    <h5>Prison Officers</h5>
                    <div style="float:right;padding-top: 7px;">
                        <?php echo $this->Html->link('Add Prison Officers',array('action'=>'add'),array('escape'=>false,'class'=>'btn btn-success btn-mini')); ?>
                        &nbsp;&nbsp;
                    </div>
                </div>
...
<?php
$ajaxUrl = $this->Html->url(array('controller'=>'officers','action'=>'indexAjax'));
