...
?>
    <tr>
      ...
      <td><?php echo date('d-m-Y',strtotime($data['Personinout']['person_in_out_date'])); ?>&nbsp;</td> 
      <td><?php echo ucwords(h($data['Personinout']['name'])); ?>&nbsp;</td> 
      <td><?php echo date('d-m-Y H:i:s',strtotime($data['Personinout']['time_in'])); ?>&nbsp;</td> 
      <td><?php echo date('d-m-Y H:i:s',strtotime($data['Personinout']['time_out'])); ?>&nbsp;</td>
      <td><?php echo ucwords(h($data['User']['first_name'])); ?>&nbsp;</td>
        ...
        <td class="actions">
          <?php echo $this->Form->create('PersoninoutEdit',array('url'=>'/personinouts/add','admin'=>false));?> 
          <?php echo $this->Form->input('id',array('type'=>'hidden','value'=> $data['Personinout']['id'])); ?>
        ...
        <td>
            <?php echo $this->Form->create('PersoninoutDelete',array('url'=>'/Personinouts/index','admin'=>false));?> 
            <?php echo $this->Form->input('id',array('type'=>'hidden','value'=> $data['Personinout']['id'])); ?>
