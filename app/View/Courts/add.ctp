					...
					<?php echo $this->Form->input('id', array('type'=>'hidden'))?>
						<div class="row-fluid">
							...
							<div class="control-group">
								...
								<div class="controls">
									<?php echo $this->Form->input('court_code',array('div'=>false,'label'=>false,'placeholder'=>'Enter Court Code','class'=>'form-control','required'));?>
								</div>
							</div>
						</div>
						</div>
					   <div class="row-fluid">
						...
						<div class="span6">
							<div class="control-group">
								...
								<div class="controls">
									<?php echo $this->Form->input('court_level_id',array('div'=>false,'label'=>false,'type'=>'select','options'=>$court_level_id,'empty'=>'-- Select Court Level --','placeholder'=>'Enter Region','class'=>'form-control','required'));?>
								</div>
							</div>
						</div>
						</div>
