...
?>              
            <td>
                ...
                <?php echo $this->Form->create('StagePromotionEdit',array('url'=>'/stages/stagesAssign/'.$uuid.'#stagePromotion','admin'=>false));?> 
                <?php echo $this->Form->input('id',array('type'=>'hidden','value'=> $stagePromotion_id)); ?>
            ...
            <td>
                <?php echo $this->Form->button('Delete', array('type'=>'button', 'div'=>false, 'label'=>false, 'class'=>'btn btn-danger', 'onclick'=>"javascript:deleteStagePromotionRecords('$stagePromotion_uuid');"))?>
            </td>
<?php
        }
?>
