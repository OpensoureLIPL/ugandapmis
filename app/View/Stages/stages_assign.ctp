                ...
                <div class="widget-content nopadding">
                    <div class="">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#stageDemotion" id="stageDemotionDiv">Stage Demotion</a></li>
                            ...
                            <div id="stageDemotion">
                                ...
                                <div class="row" style="padding-bottom: 14px;">
                                  <div class="span6">
                                    ...
                                    <div class="span6">
                                       <div class="control-group">
                                            <label class="control-label">Probation Period<?php echo $req; ?> :</label>
                                            <div class="controls">
                                ...
                                <div class="row" style="padding-bottom: 14px;">
                                  <div class="span6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <?php echo $this->Form->input('reinstatement_date',array('div'=>false,'label'=>false,'class'=>'form-control mydate span11','type'=>'text', 'placeholder'=>'Enter Demotion  Date','required','readonly'=>'readonly',));?>
                                            </div>
                                        </div>
                                    </div>                             
                                    <div class="span6">
...
<?php
$stagePromotionUrl         = $this->Html->url(array('controller'=>'Stages','action'=>'stagesAssignAjax'));
